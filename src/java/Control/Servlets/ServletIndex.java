...
public class ServletIndex extends HttpServlet {
    ...
    private HoroscopoDAO indexdao;
    private HoroscopoVO mensaje;
    
    public ServletIndex() throws SQLException, ClassNotFoundException{
        //se crea un objeto de tipo HoroscopoDAO para gestionar consultas del horóscopo en la base de datos
        indexdao = new HoroscopoDAO();
    }
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //se obtiene el valor del signo zodiacal a través del método GET
            String signo = request.getParameter("signo");
            
            //se obtiene las predicciones del día utilizando como argumento el valor obtenido anteriormente
            mensaje = indexdao.mostrarMensajeDiario(signo);
            ...
            //header que muestra el titulo y un enlace para iniciar sssión
            out.println("<header class=\"header\">");
            out.println("<div class=\"container\">");
            out.println("<h3>Horóscopo</h3>");
            out.println("<a href=\"vistas/login.jsp\">Iniciar Sesión</a>");
            out.println("</div>");
            out.println("</header>");
            ...
            realiza una petición para que responda con la predicción del día del signo zodiacal seleccionado y diseñe la página
            */
            ...
            out.println("<td>");
            out.println("<center>");
            out.println("<form action=\"ServletIndex\" method=\"get\">");
            ...
            //muestra la imagen del signo zodiacal seleccionado
            out.println("<div class=\"zodiac-properties\">");
            out.println("<div id=\"zodiac-img\">");
            if(signo.equals("aries"))
            ...
            out.println("</div>");
            //muestra el nombre del signo zodiacal seleccionado
            out.println("<div id=\"zodiac-name\">");
            if(signo.equals("aries"))
            ...
            out.println("<h2>Predicción del día:"+obtenerDia()+"/"+obtenerMes()+"</h2>");
